define([
    ...
    'dojo/text!./FMV/templates/FMV.html',
    'dijit/form/Select',
    'dijit/dijit',
    'esri/geometry/Extent',
    'xstyle/css!./FMV/css/FMV.css'
], function(declare, _WidgetBase, _TemplatedMixin, xhr, base64, array, dom, on, lang,
            dojo, PictureMarkerSymbol, Point, Polyline, SimpleMarkerSymbol,
            SimpleLineSymbol, Color, Graphic, GraphicsLayer, SimpleRenderer,
            SpatialReference,
            template, Select, dijit, Extent) {

    return declare([_WidgetBase, _TemplatedMixin], {
        templateString: template,
        plane_icon: require.toUrl('gis/dijit/FMV/images/plane_blue.png'),
        postCreate: function () {
